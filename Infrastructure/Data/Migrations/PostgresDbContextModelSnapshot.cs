...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Culture", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Models.BotUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Models.UserSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Models.BotUser", b =>
                {
                    b.HasOne("Core.Models.UserProfile", "UserProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.UserProfile", b =>
                {
                    b.HasOne("Core.Models.Culture", "Culture")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.UserSubscription", b =>
                {
                    ...
                    b.HasOne("Core.Models.BotUser", "BotUser")
                        .WithMany()
